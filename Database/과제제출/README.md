...
```sql
sqlite> SELECT COUNT(*) FROM healthcare WHERE waist = "" ;
```
...
```sql
SELECT * FROM healthcare ORDER BY waist DESC LIMIT 5 OFFSET 107;
```

```
id      sido  gender  age  height  weight  waist  va_left  va_right  blood_pressure  smoking  is_drinking
------  ----  ------  ---  ------  ------  -----  -------  --------  --------------  -------  -----------
990121  48    2       17   160     65             0.3      0.4       130             1        0
484093  27    2       9    160     60      999.0  1.5      1.5       118             1        0
590867  11    2       9    155     45      680.0  1.2      1.2       99              1        0
993531  48    1       9    170     130     146.0  0.6      0.8       150             3        1
866337  27    1       9    170     135     144.0  1.0      1.2       124             3        0
-- 개인적으로 5번이 맞는지 찜찜해서 검토해 봤습니다. 
```
